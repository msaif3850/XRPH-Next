...
export const generateMetadata = (): Metadata => {
    return {
        ...
        alternates: {canonical: "https://www.xrphealthcare.ai/apps"},
        openGraph: {
            images: [
                {
                    url: "https://xrphealthcare.ai/meta/xrph-ai.png",
                    width: 1200,
                    height: 630,
                    alt: "XRPH AI",
                },
        ...
        twitter: {
            images: ["https://xrphealthcare.ai/meta/xrph-ai.png"],
        },
    };
};
export default function XrphWallet() {
    return (
        <>
            <div className="max-w-5xl mx-auto text-center pt-24 sm:pt-32 px-6 sm:px-0">
                <div className="flex flex-col lg:flex-row justify-center items-center gap-8">
                    <div className="w-full lg:w-1/3 order-1 sm:order-0">
                    ...
                    <div className="w-full lg:w-1/2 order-0 sm:order-1">
                        <div className="text-center px-0 lg:px-8">
                            <h2 className="text-lg sm:text-2xl font-semibold mb-3 sm:mb-6">Scan to download the app</h2>
                            <div>
                                <QrImage type={'ai'} width={200} height={200} className={'w-1/2 sm:w-1/3'}/>
                            </div>
            ...
            <div className="hidden">
                            ...
                            <div className="flex flex-col lg:flex-row justify-center items-center gap-8">
                                <div className="w-full lg:w-1/3">
                                    <div className="border-4 border-light rounded-3xl shadow-lg dark:bg-gray-900">
                                        <div
                                            ...
                                            <p className="mt-2 ">
                                                Holistic <span className="font-sans">&</span> Traditional Medical
                                                Insights,
                                                Powered by AI
                                            </p>
                                        </div>
                                ...
                                <div className="w-full lg:w-1/2">
                                    <div className="text-center px-6 lg:px-8">
                                        <h2 className="text-lg sm:text-2xl font-semibold mb-6">Scan to download the
                                            app</h2>
                                        <div>
                        ...
                        <div className="flex flex-col lg:flex-row justify-center items-center gap-8">
                            ...
                            <div className="w-full lg:w-1/3 ">
                                <div className="text-center px-6 lg:px-8">
                                    ...
                                    <div>
                                        <QrImage type={'ai'} width={200} height={200} className={'w-1/2'}/>
                                    </div>
                                    <div className="my-4 relative">
                                        <div className="absolute inset-0 flex items-center">
                                            <div className="w-full border-t border-2 border-jamni"></div>
                ...
                <div className="hidden  --flex items-center sm:pb-22">
                    <div className="w-full text-center">
                        <div className="flex flex-col lg:flex-row justify-center items-center gap-8">
