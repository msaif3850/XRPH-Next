...
export default function XRPHSavingsCard() {
    return (
        <>
            <HeadTag title="XRPH Prescription Savings Card & App"
                     canonical="https://www.xrphealthcare.ai/XRPHSavingsCard"/>
            <div className="px-6 py-24 sm:py-22 lg:px-8">
                <div className="mx-auto max-w-5xl text-center">
                    <h1 className="text-3xl lg:text-5xl lg:leading-[1.2] -text-5xl font-semibold tracking-tight text-gradient ">XRPH
                        Prescription
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center px-6">
                <div className="w-full md:w-1/2">
                    ...
                    >
                        <div
                            className="w-full bg-psca bg-center bg-cover flex min-h-[200px] sm:min-h-[360px] items-center justify-center rounded-lg shadow-md relative"
                        ...
                        <ul className="list-none space-y-4">
                            <li className="text-2xl leading-snug flex items-start gap-2">
                                <Image width={'20'} height={'20'} src={"/arrow-gradient.png"} alt={"arrow"}
                                       className="w-5 mt-2"/>
                                <div>
                                    Unlock Savings of Up to 80{FixText('%')} on Your Prescription and Medications with
                                    Unlimited Usage.
                                </div>
                            </li>
                            <li className="text-2xl leading-snug flex items-start gap-2">
                                <Image width={'20'} height={'20'} src={"/arrow-gradient.png"} alt={"arrow"}
                                       className="w-5 mt-2"/>
                                <div>
                                    Accepted at More Than 68,000 Pharmacies Across the United States, including
                            ...
                            <li className="text-2xl leading-snug flex items-start gap-2">
                                <Image width={'20'} height={'20'} src={"/arrow-gradient.png"} alt={"arrow"}
                                       className="w-5 mt-2"/>
                                <div>
                                    Powered by XRPH AI {FixText('-')} Your Personal Multi{FixText('-')}lingual Health
                                    Assistant.
                                </div>
                            </li>
                            <li className="text-2xl leading-snug flex items-start gap-2">
                                <Image width={'20'} height={'20'} src={"/arrow-gradient.png"} alt={"arrow"}
                                       className="w-5 mt-2"/>
                                <div>
                                    Get Your Free XRPH Prescription Savings Card by Downloading it Today{FixText('!')}
                                </div>
                            </li>
                        </ul>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 px-6 py-24 sm:py-22">
                ...
                <div className="w-full lg:w-7/12">
                    ...
                    <p className="text-lg mb-6">
                        At XRP Healthcare, we believe everyone deserves access to affordable medication. Our
                        Prescription Savings Card offers significant discounts on medication and prescription drugs,
                        helping you save money and manage your health more effectively. With XRPH AI, your personal
                        multi-lingual health assistant, you can easily access your savings card and manage your health
                        expenses seamlessly.
                    </p>
                    ...
                    <p className="text-lg mb-6">
                        Our Prescription Savings Card is simple to use. Present it at any participating pharmacy to
                        receive discounts on your prescriptions. No insurance is needed, and the card is available to
                        everyone, regardless of income or health status. This card is for anyone that needs or may need
                        medication from a U.S. pharmacy.
                    </p>

                    <MyButton
                        buttonText="Read More"
                        buttonUrl="/docs/XRPH-Prescription-Savings-Card.pdf"
                        target="_blank"
                    />
                </div>

                {/* RIGHT IMAGE - DESKTOP ONLY */}
                <div className="w-full lg:w-5/12 p-4 pl-0 hidden lg:block">
                    <Link
                        href={"/docs/XRPH-Prescription-Savings-Card.pdf"}
                        target="_blank"
                        title="XRP Healthcare Prescription Savings Card Brochure"
                ...
                <div className="flex flex-col lg:flex-row items-center gap-8 px-6 py-24 sm:py-22">
                    <div className="w-full lg:w-7/12">
                        ...
                        <p className="text-lg mb-6">
                            ...
                            Prescription Savings Card offers significant discounts on medication and prescription drugs,
                            helping you save money and manage your health more effectively. With XRPH AI, your personal
                            multi-lingual health assistant, you can easily access your savings card and manage your
                            health expenses seamlessly.
                        </p>
                        <p className="text-lg mb-6">
                            Our Prescription Savings Card is simple to use. Present it at any participating pharmacy to
                            receive discounts on your prescriptions. No insurance is needed, and the card is available
                            to everyone, regardless of income or health status. This card is for anyone that needs or
                            may need medication from a U.S. pharmacy.
                        </p>
                ...
                <div className="flex flex-col lg:flex-row items-center gap-8 px-6 ">
                    ...
                    <div className="w-full lg:w-7/12">
                        ...
                        <p className="text-lg mb-6">
                            ...
                            pharmacies
                            we have partnered with, make sure to give them your unique ID number located on image of
                            your
                            card
                            in the XRPH App.
                            <br/><br/>
                            <b>PAYMENTS:</b>
                            You will receive <span className="font-sans">$1</span> worth of XRPH each time your card is
                            used.
                            Payments
                            ...
                            is a drug coupon. This is not a Medicare prescription drug plan and is privately supported.
                            This
                            is
                            not a
                            government run<span className="font-sans">/</span>affiliated<span
                            className="font-sans">/</span>funded
                            program.
                            Discounts
